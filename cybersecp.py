...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setStyleSheet(u"border-image:url(:/background/fundoc.jpg);\n"
...
"font-size: 30px;")
        ...
        self.label_2.setGeometry(QRect(130, 130, 151, 61))
        self.label_2.setStyleSheet(u"border-image:0;\n"
"color: blue;\n"
"font-weight: bold;\n"
"font-size: 20px")
        self.widget = QWidget(Dialog)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(10, 140, 401, 171))
